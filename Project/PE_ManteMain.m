...
projectfolder   ='~/Data/Miller/FindNetTone_V';
...
...       'pEE',                      {{ 0.08, 0.15}}, ...
       'WEErecurrent_factor',      m2c(linspace(150,250,10)), ...
       'WEEasym_factor',           {{10,35,50}},  ...
       'WEI_factor',               m2c(linspace(-270,-370,10)), ...
       'WIE_factor',               m2c(linspace(270,370,10)) ...
	);
