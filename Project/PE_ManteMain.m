...
projectfolder   ='~/Data/Miller/FindNetTone_VI';
...
...       'pEE',                      {{ 0.08, 0.15}}, ...
       ...
       'WEEasym_factor',           {{30,35,40,45}},  ...
       'WEI_factor',               m2c(linspace(285,335,10)), ...
       'WIE_factor',               m2c(linspace(-335,-285,10)) ...
	);
...
consts = struct( ...
       ...
       ... ---TASK PARAMETERS---
           ...
           'trialDuration', 2.0,  ... 3, ...
           ... General Stimulus
           'iFrac',         0.2, ...   Randomly select a third of the population for a stimulus to receive
           ... Context Stimulus
